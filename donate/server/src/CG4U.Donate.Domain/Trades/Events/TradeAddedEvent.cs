...
{
    public class TradeAddedEvent : Event
    {
        public TradeModel TradeModel { get; set; }

        public TradeAddedEvent(ILogger logger, TradeModel tradeModel)
            : base(logger)
        {
        ...
        public override void NotifyEventHandled()
        {
            Logger.LogInformation(
                string.Format(
                    "{0} __ Trade Event Added successfully. Trade.Id {1}, UserGet.Id {2}, UserLet.Id {3}",
