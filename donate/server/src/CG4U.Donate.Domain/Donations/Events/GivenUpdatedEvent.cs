...
{
    public class GivenUpdatedEvent : Event
    {
        public GivenModel GivenModel { get; set; }

        public GivenUpdatedEvent(ILogger logger, GivenModel givenModel)
            : base(logger)
        {
        ...
        public override void NotifyEventHandled()
        {
            Logger.LogInformation(
                string.Format(
                    "{0} __ Given Event Updated successfully. Donation.Id {1}, User.Id {2}",
