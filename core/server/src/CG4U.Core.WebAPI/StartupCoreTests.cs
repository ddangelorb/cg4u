...
using CG4U.Core.Infra.CrossCutting.Ioc;
...
namespace CG4U.Core.WebAPI
{
    public class StartupCoreTests
    {
        public IConfiguration Configuration { get; }

        public StartupCoreTests(IConfiguration configuration)
        {
        ...
        private void ConfigureInternalServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                //options.AddPolicy("Donation.GetById", policy => policy.RequireClaim("Donation.GetById", "True"));
