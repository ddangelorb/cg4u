...
using CG4U.Security.Services.Services.Mock;
...
namespace CG4U.Security.Infra.CrossCutting.Ioc
{
    public class NativeInjectorBootStrapperTests
    {
        public static void RegisterServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IComputerVisionAdapter, ComputerVisionAdapterMock>();
            services.AddScoped<IFaceAdapter, FaceAdapterMock>();
